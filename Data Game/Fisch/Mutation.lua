return {
	...
	["Zeus's Storm"] = {
		...
		Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 238, 51)),
			ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 255, 189)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 238, 51))
		})
	},
	Cragged = {
		PriceMultiply = 7,
	...
	Gravitas = {
		...
		Display = "Gravitas",
		Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.fromRGB(191, 146, 255)),
			ColorSequenceKeypoint.new(0.5, Color3.fromRGB(217, 111, 167)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 162, 48))
		})
	},
	["Hades' Curse"] = {
		PriceMultiply = 11.1,
	...
	Bliss = {
		...
		Display = "Bliss",
		Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.fromRGB(216, 160, 249)),
			ColorSequenceKeypoint.new(0.5, Color3.fromRGB(151, 249, 249)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(141, 255, 135))
		})
	},
	Verdant = {
		PriceMultiply = 9.2,
		...
		Display = "Verdant",
		Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.fromRGB(73, 221, 10)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(175, 223, 0))
		})
	},
	Blossomed = {
		PriceMultiply = 4.6,
	...
	Plagued = {
		...
		Display = "Plagued",
		Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.fromRGB(32, 27, 52)),
	...
	Igneous = {
		...
		Color = ColorSequence.new({
			...
			ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 199, 56))
		})
	},
	Solar = {
		PriceMultiply = 5.3,
	...
	Bouka = {
		...
		Priority = 0.1,
		Display = "Bouka",
		Color = ColorSequence.new(Color3.fromRGB(255, 240, 162), Color3.fromRGB(255, 225, 103))
	},
	Idol = {
		PriceMultiply = 8.01,
		Chance = 0,
		Priority = 0.1,
		Display = "Idol",
		Color = ColorSequence.new(Color3.fromRGB(62, 255, 216), Color3.fromRGB(64, 220, 255))
	},
	Sinister = {
		PriceMultiply = 2.9,
		Chance = 0,
