...
v10.Secondary = true
v10.RelicGroup = "Festive"
v10.CanSelectFromAdmin = false
v5.Peppermint = v10
local v12 = {
...
v13.ClientFishingPassives = v14
v13.RelicGroup = "Twisted"
v13.CanSelectFromAdmin = true
v5.Rage = v13
v5.Greed = {
...
v16.RelicGroup = "Spooky"
v16.CanSelectFromAdmin = false
v5.Spooky = v16
local v18 = {
    ["Description"] = "<$Mutations.1.Chance$>% chance for <$Mutations.1.Name$> mutation, increases fish size by <$WeightBoost$>%, & increases Progress Speed by <$ProgressSpeed$>%",
...
v21.FishingPassives = v22
v21.RelicGroup = "Default"
v21.CanSelectFromAdmin = true
v5.Wormhole = v21
v5.Resilient = {
...
v5.Breezed = {
    ...
    ["ConditionalBoosts"] = function(p26, _) --[[ Name: ConditionalBoosts, Line 621 ]]
        ...
        Upvalues:
            [1] = u1
        --]]
        if u1.world.weather.Value == "Windy" then
            return {
                ["Luck"] = p26.Luck * 2,
                ["Lure"] = p26.Lure * 2,
                ["ProgressSpeed"] = p26.ProgressSpeed * 2
            }
        end
    end,
    ["RelicGroup"] = "Default",
...
v31.ClientFishingPassives = v32
v31.RelicGroup = "Exalted"
v31.CanSelectFromAdmin = true
v5.Piercing = v31
local v33 = {
...
v33.RelicGroup = "Exalted"
v33.CanSelectFromAdmin = true
v5.Anomalous = v33
v5["Sea Overlord"] = {
    ["Description"] = "Makes fish <$WeightBoost$>% bigger",
...
v36.Generic_BoostFishChances = v37
v35.FishingPassives = v36
v35.Scavenging = 200
v35.RelicGroup = "Default"
...
v40.FishingPassives = v41
v40.RelicGroup = "Default"
v40.CanSelectFromAdmin = true
v5["Blood Reckoning"] = v40
local v42 = {
