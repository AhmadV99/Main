...
local _main = Window:MakeTab("Main") do
  ...
  local _Macros = _main:Section({["Title"] = "Macros / Play", ["Content"] = ""}) do
    ...
    Funcs:AddTextbox(_Macros, "Import Macro", "Input Only Url Raw and Not Use Macro String JSON", "", true)
    Funcs:AddToggle(_Macros, "Allow Import Macro Without Use Select File", "", false)
