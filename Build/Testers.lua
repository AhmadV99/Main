...
task.spawn(function()
    while task.wait() do
        pcall(function()
            Status1:Set("World: ".. GetStatus("World"))
            Status2:Set("Race: ".. GetStatus("Race"))
            Status3:Set("Level: ".. GetStatus("Level"))
            Status5:Set("Bounty: ".. GetStatus("Bounty"))
            Status6:Set("Shisui: ".. GetStatus("Shisui"))
        end)
    end
end)
if World2 or World3 then
