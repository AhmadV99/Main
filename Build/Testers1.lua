...
if World2 or World3 then
  ...
  Silder(SeaEvent, "Return Safe At Heath %", 0, Player.Character.Humanoid.Health.Value, 5000)
  Silder(SeaEvent, "Return Back At Heath %", 0, Player.Character.Humanoid.Health.Value, 8000)
