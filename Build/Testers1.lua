...
Dropdown(Glitcher, "Choose At Stopping Strength Number On Pets", "", {"Go To Farm Select Gym", "Go To Farm Rebirths [Stopping Rebirths Number]"}, "2")
Glitcher:AddSection({"Config Farm"})
Dropdown(Glitcher, "Choose Rock Map", "", {"Frost","Mystical","Eternal","Legends","Muscle King"}, "Muscle King")
Toggle(Misc, "Auto Farm On Choose Rock Map", "", false)
