...
local update2 = Dropdown(Stats, "Select Player Stats", "", getgenv().TablePlayer, "")
Stats:AddButton({Name = "Refersh Player", Description = "", Callback = function()
  update2:Set(getgenv().TablePlayerR)
end})
getgenv().AddStatus(Stats)
Stats:AddSection({" - [ Main Status ] - "})
getgenv().AddStatusMain(Stats)
Stats:AddSection({" - [ Earn Status ] - "})
getgenv().AddStatusEarn(Stats)
