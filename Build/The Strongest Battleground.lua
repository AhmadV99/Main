...
if game.Players.LocalPlayer.UserId == 1724621193 then
  ...
  Farming:AddSection({"HitBox"})
  Silder(Farming, "Size X", 0, 1000, 50)
  Silder(Farming, "Size Y", 0, 1000, 50)
  Silder(Farming, "Size Z", 0, 1000, 50)
  Dropdown(Farming, "Choose Color", "", {"Red","Green","Blue","Yellow","Purple","Orange","Pink","Brown","Black","White","Gray","Cyan","Magenta","Lime","Olive","Maroon","Navy","Teal","Silver","Gold"}, "Red")
  Silder(Farming, "Transparency", 0, 1, 0.5)
  Toggle(Farming, "HitBox Player", "", false)
end
