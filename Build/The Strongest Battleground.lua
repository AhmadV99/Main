...
Main:AddSection({"Aim"})
Dropdown(Main, "Choose Aim Part", "", {"Head", "Torso", "HumanoidRootPart", "LeftArm", "RightArm", "LeftLeg", "RightLeg"}, "Head")
Toggle(Main, "Aimlock", "Aimlock = Lock Camera Player", false)
Main:AddSection({"Body"})
Toggle(Main, "Anti-Knockback", "", false)
Toggle(Main, "Anti-Stun", "", false)
Toggle(Main, "Anti-Busy", "", false)
Window:SelectTab(2)
return SpeedHubX
