local SPD = getgenv and getgenv() or {} do 
  function SPD:Hooking(Type, ...)
  ...
  function SPD:HiddenProperty(Type, ...)
  ...
  function SPD:FileSystem(Type, Type_1, ...)
