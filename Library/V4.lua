...
local Themes = {
	...
	SpeedHubX = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 25, 25), Color3.fromRGB(5, 5, 5)),
		AcrylicNoise = 0.85,
	
		TitleBarLine = Color3.fromRGB(220, 40, 40),
		Tab = Color3.fromRGB(255, 30, 30),
	
		Element = Color3.fromRGB(255, 50, 50),
		ElementBorder = Color3.fromRGB(45, 45, 45),
		InElementBorder = Color3.fromRGB(85, 85, 85),
		...
		DropdownOption = Color3.fromRGB(255, 90, 90),
	
		Keybind = Color3.fromRGB(235, 40, 40),
		...
		DialogInputLine = Color3.fromRGB(255, 80, 80),
